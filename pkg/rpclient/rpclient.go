...
func (c *RpcClient) CallWrapper(method string, params any, resp any) (err error) {
...
func (c *RpcClient) CallWalletWrapper(wallet, method string, params any, resp any) (err error) {
	r, err := c.CallWallet(wallet, method, params)
	if err != nil {
		return
	}
